...
namespace radix
{
    public class GPURadixSortParticles
    {
        ...
        public const int sortSectionNum = 256;
        ...
        public GPURadixSortParticles(ComputeShader shader, int particleNum,int size)
        {
            _shaderRadixSort = shader;
            shader.SetFloat("_ParticleNum",particleNum);
            ...
            _bufferSortedParticles = new ComputeBuffer(_particleNum, size);
